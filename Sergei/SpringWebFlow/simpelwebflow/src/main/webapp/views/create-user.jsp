...
<head>
    ...
    <title><spring:message code="create-user"/></title>
</head>
<body>
    ...
    <div class="loginmodal-container">
        <form:form method="post" modelAttribute="user">
            ...
            <footer>
                ...
                <input type="submit" value="<spring:message code="create-user"/> " name="_eventId_submit">
            </footer>
        </form:form>
    </div>
</div>
<a href="/download">ВЫХОД С ПОТОКА(2 ОБРАБОТЧИКА)</a>
</body>
</html>
